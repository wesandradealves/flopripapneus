<section class="section" data-section="contatos">
    <div class="container d-flex flex-column flex-md-row flex-wrap align-items-center justify-content-between">
        <div class="section-header col-12 col-md-5 col-lg-4">
        ...
        <div class="d-flex col-12 col-md-6 ps-md-5 mt-5 mt-md-0 align-items-center align-items-lg-end flex-column">
