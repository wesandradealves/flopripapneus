                        ...
                        <li class="item col-12 col-lg-6 d-flex flex-column justify-content-center align-items-center">
                            <div class="card --thumbnail">
                                <div class="card-inner d-flex flex-column">
                                    <img src="<?php echo get_the_post_thumbnail_url(); ?>" alt="<?php echo get_the_title(); ?>" class="img-fluid mb-4">
                                    <h3 class="title mb-2 mt-5"><?php echo get_the_title(); ?></h3>
                                    <p class="text">
                                        <?php echo strip_tags(get_the_content()); ?>
                                    </p>
                                    <?php if(get_page_by_title( 'Contato' )) : ?>
                                        <a href="<?php echo get_permalink( get_page_by_title( 'Contato' ) ); ?>?servico=<?php echo get_the_id(); ?>" class="btn default d-inline-flex --variation ms-auto mt-5">Quero um Orçamento</a>
                                    <?php endif; ?>                                       
                                </div>
                            </div>                        
                        </li>                        
